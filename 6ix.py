...
ctypes.windll.kernel32.SetConsoleTitleW(f'[Givenchy Selfbot v{SELFBOT.__version__}] | Loading...')
...
async def help(ctx):
    ...
    em.add_field(name="`CMD`",value="Various Server Commands",inline=False)
    em.add_field(name="`AMC`",value="Account Management Commands",inline=False)
    em.add_field(name="`Util`",value="Utility Commands",inline=False)
    em.add_field(name="`Hacking`",value="For Being a Skid",inline=False)   
    em.add_field(name="`Wizzing`",value="To Nuke Servers",inline=False)   
    em.set_footer(text="by pix edited by cooper (if someone is hosting this for you change your password IMMEDIATLY)")
    await ctx.send(embed=em)
@SIX.command()
async def cmd(ctx):
    await ctx.message.delete()
    em = discord.Embed(color= discord.Color(random.randint(0x000000, 0xFFFFFF)))
    em.set_author(name="CMD")
    em.add_field(name="`av @user`",value="Avatar of Pinged User",inline=False)
    em.add_field(name="`whois @user`",value="Shows Info About User",inline=False)
    em.add_field(name="`role-hexcode @role`",value="Gives Hexcode of Role",inline=False)
    em.add_field(name="`guildicon`",value="Shows Guild Icon",inline=False)
    em.add_field(name="`roleinfo @role`",value="Shows Info About a Role",inline=False)
    em.add_field(name="`purge #`",value="Deletes your messages based on the amount you specify",inline=False)
    em.add_field(name="`spam amount message`",value="Sends Message x Amount of Times",inline=False)
    em.add_field(name="`clear`",value="Spam the chat with invisible messages",inline=False)
    em.set_footer(text="by pix edited by cooper (if someone is hosting this for you change your password IMMEDIATLY)")
    await ctx.send(embed=em)
@SIX.command()
async def gifs(ctx):
...
async def amc(ctx):
    await ctx.message.delete()
    em = discord.Embed(color= discord.Color(random.randint(0x000000, 0xFFFFFF)))
    em.set_author(name="AMC")
    em.add_field(name="`setpfp url`",value="Set Your PFP As URL",inline=False)
    em.add_field(name="`pfpsteal @user`",value="Steals Mentioned Users PFP",inline=False)
    em.add_field(name="`group-leaver`",value="Leaves All The Groups Your In",inline=False)
    em.add_field(name="`backup-f`",value="Backup Your Friends Accounts to a TXT",inline=False)
    em.add_field(name="`blank`",value="Turns Your Name + PFP Blank",inline=False)
    em.add_field(name="`read`",value="Marks All Messages Read Except DM (Probably Will Get RateLimited)",inline=False)
    em.add_field(name="`hypesquad whateverhypesquaduwant`",value="Set Your Hypesquad No Quiz",inline=False)
    em.add_field(name="`fakenet leagueoflegends, skype, battlenet x`",value="Fakes Connection On Your Profile",inline=False)
    em.add_field(name="`𝐬etS`",value="Custom Stream",inline=False)
    em.add_field(name="`setG`",value="Custom Playing Status",inline=False)
    em.add_field(name="`setL`",value="Custom Listening Status",inline=False)
    em.add_field(name="`setW`",value="Custom Watching Status",inline=False)
...
async def util(ctx):
    await ctx.message.delete()
    em = discord.Embed(color= discord.Color(random.randint(0x000000, 0xFFFFFF)))
    em.set_author(name="UTIL")
    em.add_field(name="`ip`",value="IP Lookup",inline=False)
    em.add_field(name="`tinyurl link`",value="Shorten Link With TinyURL",inline=False)
    em.add_field(name="`mac`",value="Lookup Info on a MAC (ie: !mac xx:xx:xx:xx:xx:xx)",inline=False)
    em.add_field(name="`encode message`",value="Encode Message 2 BASE64",inline=False)
    em.add_field(name="`decode base64`",value="Decode BASE64",inline=False)
    em.add_field(name="`eth`",value="Display ETH Price",inline=False)
    em.add_field(name="`btc`",value="Display BTC Price",inline=False)
    em.add_field(name="`auto-bump`",value="Auto Bumps on Disboard",inline=False)
    em.add_field(name="`get-hwid`",value="Print HWID In Console",inline=False)
    em.add_field(name="`copy`",value="Steals Server (Only Copies Visible Channels)",inline=False)
    em.add_field(name="`hastebin message`",value="Uploads Text to Hastebin",inline=False)
    em.add_field(name="`clear`",value="Clears Currently Visible Texts With Clear Text",inline=False)  
    em.add_field(name="`spam (amount) (message)`",value="Spams Message x Amount Of Timess",inline=False)
    em.add_field(name="`pingweb website`",value="Pings a Website",inline=False)
    em.set_footer(text="by pix edited by cooper (if someone is hosting this for you change your password IMMEDIATLY)")
    await ctx.send(embed=em)
@SIX.command()
async def hacking(ctx):
    await ctx.message.delete()
    em = discord.Embed(color= discord.Color(random.randint(0x000000, 0xFFFFFF)))
    em.set_author(name="Skidding :)")
    em.add_field(name="`tokeninfo token`",value="Display Information About Token",inline=False)
    em.add_field(name="`tokenfuck token`",value="Fuck Up Someones Discord Forever",inline=False)
    em.add_field(name="`masslogin token`",value="MassLogin To Bot or User Tokens",inline=False)
    em.set_footer(text="by pix edited by cooper (if someone is hosting this for you change your password IMMEDIATLY)")
    await ctx.send(embed=em)
@SIX.command()
async def wizzing(ctx):
    await ctx.message.delete()
    em = discord.Embed(color= discord.Color(random.randint(0x000000, 0xFFFFFF)))
    em.set_author(name="Nuking")
    em.add_field(name="`six`",value="Nukes",inline=False)
    em.add_field(name="`dmall message`",value="Might Get You Disabled",inline=False)
    em.add_field(name="`massB`",value="Ban All",inline=False)
    em.add_field(name="`massK`",value="Kick All",inline=False)
    em.add_field(name="`massR`",value="Mass Create Roles",inline=False)
    em.add_field(name="`massC`",value="Mass Create Channels",inline=False)
    em.add_field(name="`delR`",value="Delete All The Roles",inline=False)
    em.add_field(name="`delC`",value="Delete All Channels",inline=False)
    em.add_field(name="`massUn`",value="Free Slime Out Da Celly",inline=False)
    em.set_footer(text="by pix edited by cooper (if someone is hosting this for you change your password IMMEDIATLY)")
    await ctx.send(embed=em)
